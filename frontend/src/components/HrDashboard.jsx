        ...
        <ul className="sidebar-nav-links">
          ...
          <li className="sidebar-link-item">
            <button 
              ...
              onClick={() => { setActiveTab('candidates'); setMobileSidebarOpen(false); }}
            >
      ...
      <main className="dashboard-main">
        ...
        <header className="dashboard-navbar">
          <div className="navbar-left">
            ...
            <h1 className="navbar-title">HR Portal</h1>
          </div>
          ...
          <div className="navbar-right">
            ...
            <div className="navbar-profile-trigger" onClick={() => setProfileMenuOpen(!profileMenuOpen)}>
              ...
              <div className="profile-details-text">
                <div className="profile-name">Sophia Martinez</div>
                <div className="profile-role-badge">HR Director</div>
              </div>

              {profileMenuOpen && (
                <div className="profile-dropdown-menu">
                  <div className="dropdown-header">Logged in as sophia@metaminds.com</div>
